                ...
                <div className="flex items-center gap-2">
                    {isAuthenticated ? (
                        <>
                            ...
                            <Link to="/my-listings"
                                className="text-gray-600 px-3 py-2 rounded-lg text-sm hover:bg-gray-100 transition" title="Mes annonces">
                                📋
                            </Link>
                            <Link to="/messages"
                                className="text-gray-600 px-3 py-2 rounded-lg text-sm hover:bg-gray-100 transition" title="Messages">
                                💬
                            </Link>
                            <Link to="/favorites"
                                className="text-gray-600 px-3 py-2 rounded-lg text-sm hover:bg-gray-100 transition" title="Favoris">
                                ❤️
                            </Link>
                            <Link to="/profile"
                                className="text-gray-600 px-3 py-2 rounded-lg text-sm hover:bg-gray-100 transition" title="Profil">
                                👤
                            </Link>
                        </>
                    ) : (
                        <>
                            <Link to="/login" className="text-gray-600 px-4 py-2 rounded-lg text-sm hover:bg-gray-100 transition">
                                Connexion
                            </Link>
        ...
        <div className="min-h-screen bg-gray-50">
                    ...
                    <div className="max-w-5xl mx-auto px-4 py-2 flex gap-2 overflow-x-auto scrollbar-hide">
                        <button
                            ...
                            className={`flex-shrink-0 px-4 py-1.5 rounded-full text-sm font-medium transition ${
                                categoryId === '' ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                            }`}
                        >
                            Tout
                        </button>
                        {categories.map(cat => (
                            <button
                                ...
                                className={`flex-shrink-0 px-4 py-1.5 rounded-full text-sm font-medium transition ${
                                    categoryId === cat.id ? 'bg-green-600 text-white' : 'bg-gray-100 text-gray-600 hover:bg-gray-200'
                                }`}
                            >
            ...
            <div className="max-w-5xl mx-auto px-4 py-6">
                <div className="flex items-center justify-between mb-4">
                    ...
                    {isAuthenticated && (
                        <Link to="/create" className="text-sm text-green-600 font-medium hover:underline">
                            + Publier
                        </Link>
                    )}
                </div>

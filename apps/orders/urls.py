...
urlpatterns = [
    ...
    path('admin/seller-payouts/<uuid:pk>/sync/',
        views.AdminSyncSellerPayoutView.as_view(),
        name='admin-seller-payout-sync'),
    path('admin/push-transfer/',
        views.AdminManualPushTransferView.as_view(),
        name='admin-push-transfer'),
